...
//为每个菜单绑定事件并执行相应的动作
$(function(){
    $(".left ul").children("li").each(function(){
        $(this).click(function(){
            $(this).addClass("active")
            $(this).children().children("span").removeClass("glyphicon-plus")
            $(this).children().children("span").addClass("glyphicon-minus")
            $(this).siblings().removeClass("active")
            $(this).siblings().children().children("span").removeClass("glyphicon-minus")
            $(this).siblings().children().children("span").addClass("glyphicon-plus")
            //$(this).parent().children("#menue1").removeClass("hide")
            $(this).children("div").removeClass("hide")
            $(this).siblings().children("div").addClass("hide")
